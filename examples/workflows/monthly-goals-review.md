...
A monthly check that compares actual recent focus to `GOALS.md`, asks whether the goals are still right, and sets up a clear validation step before any edits happen.

**Trigger:** Mac Mini Monday-morning automation on the first Monday of the month, or "review my goals", "monthly goals review"
**Frequency:** Monthly
...
- `things-sync/` task activity or current task stack
...
The review output should make the decision easy to validate. Present a short keep/change/remove/add summary rather than a vague reminder.
